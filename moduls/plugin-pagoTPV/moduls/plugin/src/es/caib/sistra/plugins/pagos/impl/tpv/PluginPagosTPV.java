package es.caib.sistra.plugins.pagos.impl.tpv;

import java.util.Map;

import es.caib.pagosTPV.persistence.delegate.DelegatePagosUtil;
...
public class PluginPagosTPV implements PluginPagosIntf{

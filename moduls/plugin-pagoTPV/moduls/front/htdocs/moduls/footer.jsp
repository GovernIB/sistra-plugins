...
<%@ taglib prefix="logic" uri="http://jakarta.apache.org/struts/tags-logic"%>
	...
	<bean:define id="idioma" value="<%=(java.lang.String) session.getAttribute(es.caib.pagosTPV.front.Constants.DATOS_SESION_IDIOMA_KEY)%>" type="java.lang.String"/>
	<bean:define id="asunto" value="<%=(java.lang.String) session.getAttribute(es.caib.pagosTPV.front.Constants.DATOS_SESION_NOMBRE_TRAMITE_KEY)%>" type="java.lang.String"/>

package es.caib.pagosTPV.front.util;
...
public class PagosFrontRequestHelper
{
    ...
    public static String getUrlMantenimientoSesionSistra( HttpServletRequest request )
    {
    	return ( String ) request.getSession().getAttribute( Constants.URL_MANTENIMIENTO_SISTRA_KEY );
    }
    
    public static void setUrlMantenimientoSesionSistra( HttpServletRequest request, String url )
    {
    	request.getSession().setAttribute( Constants.URL_MANTENIMIENTO_SISTRA_KEY, url );
    }

...
public class DatosPagoController extends BaseController
{
			...
			ServletContext servletContext) throws Exception
	{
		...
		EstadoSesionPago sesionPago = dlg.obtenerEstadoSesionPago();
	    ...
	    // Verificamos tipos de pago permitido
	    ...
	    request.setAttribute("identificador",sesionPago.getIdentificadorPago());

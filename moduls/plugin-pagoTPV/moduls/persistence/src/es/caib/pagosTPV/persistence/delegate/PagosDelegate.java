...
import es.caib.pagosTPV.persistence.intf.PagosTPVFacade;
import es.caib.pagosTPV.persistence.util.PagosTPVFacadeUtil;
...
public class PagosDelegate implements StatelessDelegate {
    ...
    /* ========================================================= */
    private PagosTPVFacade getFacade() throws NamingException,CreateException,RemoteException {      	    	
    	return PagosTPVFacadeUtil.getHome().create();
    }

...
public class ServiceLocator extends org.apache.axis.client.Service implements es.caib.pagos.services.wsdl.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://www.atib.es/servicios/service.asmx";
    ...
    public es.caib.pagos.services.wsdl.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.caib.pagos.services.wsdl.ServiceSoapStub _stub = new es.caib.pagos.services.wsdl.ServiceSoapStub(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "http://www.atib.es/servicios/service.asmx";
    ...
    public es.caib.pagos.services.wsdl.ServiceSoap getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.caib.pagos.services.wsdl.ServiceSoap12Stub _stub = new es.caib.pagos.services.wsdl.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.caib.pagos.services.wsdl.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                es.caib.pagos.services.wsdl.ServiceSoapStub _stub = new es.caib.pagos.services.wsdl.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (es.caib.pagos.services.wsdl.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                es.caib.pagos.services.wsdl.ServiceSoap12Stub _stub = new es.caib.pagos.services.wsdl.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.atib.es/services/", "Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.atib.es/services/", "ServiceSoap"));
            ports.add(new javax.xml.namespace.QName("http://www.atib.es/services/", "ServiceSoap12"));
        }

...
<!--  Enlace volver  -->
<%if(session.getAttribute(es.caib.pagos.front.Constants.URL_RETORNO_SISTRA_KEY) != null && !"".equals(session.getAttribute(es.caib.pagos.front.Constants.URL_RETORNO_SISTRA_KEY))){%>
